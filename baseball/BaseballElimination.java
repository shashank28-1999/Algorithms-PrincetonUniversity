...
public class BaseballElimination {
    ...
    private void calculateElimination(String team) {
        ...
        for (int i = 0; i < this.numberOfTeams(); i++) {
            ...
            FlowEdge teamToSinkEdge = new FlowEdge(opponentIndex, SINK_INDEX,
                                                   maxWins - this.wins[i]);
            ...
            for (int j = 0; j < i; j++) {
                ...
                FlowEdge team1WinEdge = new FlowEdge(gameEdgeIndex, opponentIndex,
                                                     Double.POSITIVE_INFINITY);
                network.addEdge(team1WinEdge);

                int team2Index = j < teamIndex ? j + 2 : j + 1;
                FlowEdge team2WinEdge = new FlowEdge(gameEdgeIndex, team2Index,
                                                     Double.POSITIVE_INFINITY);
