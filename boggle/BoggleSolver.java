...
public class BoggleSolver {
    ...
    private static class Node {
        ...
        int value = -1;
        // or we can handle the end of string with value,any value except -1 will indicate the end  of string
    }
    ...
    private void dfs(BoggleBoard board, Node x, int i, int j, String word, SET<String> validWords,
                     boolean[][] visited) {
